...
where b.id = '$exec6' ORDER BY b.id DESC) a","*","") as $dpt){}

		foreach($con->select("people","*","id = '$_POST[peopleid]'") as $head){}
        ...
        foreach($asign as $is){
			...
			if($is['approval_type'] == 2){
				$text .= "Please Approve this Request Follow this <a href='http://192.168.31.25/ontrack'>LINK</a>
							<br><br>
							here's the Guide:
							<br>
							1. Login <br>
							2. Menu People - Approve Request - Click green pencil icon <br>
				...
				$text .= "View Progress Request Follow this <a href='http://192.168.31.25/eraticket/index.php?x=viewnewreq&d=$exec6'>LINK</a>
							<br>
							<br>
							regards, <br>
							IT Ticketing Admin <br>";
