...
$namabesar='ERATEX DJAJA TBK';
        ...
        if($_GET['page']=="newrequestacc"){
        include('apps/report/permintaanakun.php');
        }
        if($_GET['page']=="newrequestaci"){
        include('apps/report/izinaksesdata.php');
        }
        if($_GET['page']=="newrequestacp"){
        include('apps/report/penutupanakun.php');
        }
