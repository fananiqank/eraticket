       ...
       <?php
        if ($_GET['tg']) {
          ...
          if($_GET['tg']== 'A' && $_GET['tg2']== 'A'){
            ...
            "a.id_tasks like '%' $cat $pri $sta $asi $tgl");
        ...
        <tr>
              <td valign="top"><?=$no?></td>
              <td valign="top"><?=$all['no_tasks']?></td>
              <td valign="top"><?=$all['nama_tasks']?></td>
              <td valign="top"><?=$all['nama_pegawai']?></td>
              <td valign="top"><?=$all['nama_kategori']?></td>
              <td valign="top"><?=$all['created_date_tasks']?></td>
              <td valign="top"><?=$all['start_date_tasks']?></td>
              <td valign="top"><?=$all['end_date_tasks']?></td>
              <td valign="top"><?=$pri?></td>
              <td valign="top"><?=$sta?></td>
              <td valign="top"><?=$isijum?></td>
              <td valign="top"><?=$all['remark_tasks']?></td>
        </tr>
        <?php $no++; } ?>
      </tbody>
