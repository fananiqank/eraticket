...
<?php
          ...
          $selmodagent = $con->select("(select a.name as namepeople, c.name as namedept, b.title,b.mobile,b.statusid,b.id as iddtl,b.typereq,a.email,b.alasanbutuh,b.tgl_butuh1,b.tgl_butuh2,b.akunakses,b.websiteakses,b.hasilpengecekanaset,b.assetid,d.headpeopleid,headstatus,DATE(headappdate) as headappdate,d.itpeopleid,itstatus,DATE(itappdate) as itappdate,b.locationid,DATE(b.created_date) as created_date_dtl,e.name as locationname from people a join people_dtl_request b on a.id=b.peopleid join clients c on b.clientid=c.id join people_dtl_approve d on b.id=d.peopledtlid join locations e on b.locationid=e.id
where b.id = '$_GET[id]' ORDER BY b.id DESC) a","*","");
          foreach ($selmodagent as $mg) {}
          
          foreach($con->select("people","*","id='$mg[headpeopleid]'") as $prov){}
          foreach($con->select("people","*","id='$mg[itpeopleid]'") as $prov2){}
          ...
          if($mg['locationname'] == 'PRB'){$lokasi = "Probolinggo";}
          else if($mg['locationname'] == 'SBY'){$lokasi = "Surabaya";}
          else if($mg['locationname'] == 'JKT'){$lokasi = "Jakarta";}

          $tglpemohon = $con->tgl_indo($mg['created_date_dtl']);
?>
<body>
  <table cellpadding="0" cellspacing="0" style="width:98%;" border="1">
      <tr>
          ...
          <td style="width:45%;font-size:20px;" align="center" class="td2 borderheader" rowspan="3">
            <h3 style="padding: 0px;">Form<h3 style="padding: 0px;margin-top:5px; margin-bottom:2px;">Permintaan Akun</h3><h4 style="font-style: normal; margin-bottom:1px;">PT. ERATEX DJAJA TBK</h4></h3>
  ...
  <table cellpadding="0" cellspacing="0" style="width:98%;" border="1">
      <tr>
        <td style="width:50%; vertical-align: top;">
            ...
            <p class="s1" style="padding-top: 6pt;padding-left: 8pt;text-indent: 0pt;text-align: left;">Nama : <b><?=$mg['namepeople']?></b> </p>
          ...
          ?>
            ...
            <p style="padding-top: 10pt;padding-left: 3px;line-height: 150%;text-align: left;"><?=$lokasi?>, <?=$tglpemohon?> </p>
            <br>
            <p class="s1" style="text-indent: 10pt;"><b>Pemohon</b></p>
            <p style="padding-left: 15pt;text-indent: 11pt;text-align: left;line-height: 30px;text-align: ;">
                <br>
                Ttd
            </p>
            <p class="s1" style="text-indent: 11pt;text-align: left;">( <b><?=$mg['namepeople']?></b> )</p>
        </td>
        <td style="width:50%">
          ...
          <?php }} ?>
            ...
            <table>
              <tr>
                <td align="center" style="width: 50%;">
                    <p style="padding-left: 3px;"><h1 style="padding-top: 2pt;padding-left: 8pt;text-indent: 0pt;text-align: center;">Permohonan disetujui</h1></p>
                    <p style="text-indent: 0pt;text-align: center;">
                        <?php echo $mg['headstatus']."<br>".$prov['name']."<br>".$mg['headappdate']; ?>
                        
                    </p>
                    <h1 style="padding-top: 8pt;padding-left: 11pt;text-indent: 0pt;text-align: center;">(  Dept. Head )</h1>
                    
                </td>
                <td align="center">
                    <h1 style="padding-top: 2pt;padding-left: 5pt;text-indent: 0pt;text-align: center;">Mengetahui</h1>
                    <p style="text-indent: 0pt;text-align: center;">
                        <?php echo $mg['itstatus']."<br>".$prov2['name']."<br>".$mg['itappdate']; ?>
                    </p>
                    <h1 style="padding-top: 8pt;padding-left: 5pt;text-indent: 5pt;text-align: center;">( IT Head)</h1>
                </td>
              </tr>
            </table>
            ...
            <p class="s1" style="padding-left: 3px;text-align: left;"><?php if($mg['headstatus'] <> ''){echo "(V)";}else{echo "( )";} ?> sudah dievaluasi oleh Dept-Head pemohon</p>
