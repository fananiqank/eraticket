...
<body>
  ...
  <table cellpadding="0" cellspacing="0" style="width:98%;" border="1">
    ...
    <tr>
        ...
        <td style="vertical-align: top;padding: 2pt;text-indent: 0pt;text-align: left;font-size: 12px;">:</td>
        <td colspan="4" style="vertical-align: top;padding: 2pt;text-indent: 0pt;text-align: left;font-size: 12px;"><?=$mg['locationname']?></td>
    </tr>
  </table>
  <br>
  <p style="padding-top: 4pt;padding-left: 8pt;padding-bottom: 8pt;text-indent: 0pt;text-align: left;font-size: 14px;">Pada hari ini tanggal <b><?=date('d-m-Y',strtotime($mg['created_date_dtl']))?></b> dengan ini mengajukan izin Akses Data terhadap File/Folder/Server *) yang terdapat pada kolom B.1, untuk keperluan : </p>
  ...
  <p style="margin-left: 40px;font-size: 14px;">1. Informasi File/Folder
    <table cellpadding="0" cellspacing="0" style="width:100%;padding-top: 6pt;padding-bottom: 6pt;margin-left: 20px;font-size: 12px;" border="1">
      <tr>
      ...
      <tr>
          <td><?=$na;?></td>
          <td><?php $foo = str_repeat($inf['filefolder'],1);
echo wordwrap($foo, 25, '<br />', true);?></td>
          <td><?php $foo = str_repeat($inf['lokasi'],1);
echo wordwrap($foo, 25, '<br />', true);?></td>
          <td><?=$inf['hakakses'];?></td>
          <td><?php $foo = str_repeat($inf['remark'],1);
echo wordwrap($foo, 25, '<br />', true);?></td>
      </tr>
    <?php } ?>
    </table>
  ...
  <table cellpadding="0" cellspacing="0" style="width:98%;padding-top: 6pt;padding-bottom: 6pt; font-size: 12px;" border="1">
      <tr>
        <td align="center" style="width:33%; vertical-align: top;padding: 4pt;">Mengetahui,</td>
        <td align="center" style="width:33%; vertical-align: top;padding: 4pt;">Disetujui,</td>
        <td align="center" style="width:35%; vertical-align: top;padding: 4pt;">Dibuat,</td>
      </tr>
      <tr>
          <td style="height:50px;" align="center"><?php echo $mg['itstatus']."<br>".$prov2['name']."<br><font style='font-size: 10px;'>".$mg['itappdate']."</font>"; ?></td>
          <td align="center"><?php echo $mg['headstatus']."<br>".$prov['name']."<br><font style='font-size: 10px;'>".$mg['headappdate']."</font>"; ?></td>
          <td align="center">ttd <br><b><?=$mg['namepeople'];?></b><br><font style="font-size: 10px;"><?=date('d-m-Y',strtotime($mg['created_date_dtl']))?></font></td>
      </tr>
      <tr>
        <td align="center" style="width:25%; vertical-align: top;padding: 4pt;">IT Head</td>
