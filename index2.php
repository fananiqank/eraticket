					...
					<div class="col-sm-12">
						<div class="col-sm-6" style="color: #484848;">
								...
								<div class="col-sm-8"  id="coldepas">
									<div class="input-group input-group-icon">
										<select data-plugin-selectTwo class="form-control populate" placeholder="None Selected" name="dep" id="dep">
										    <option value=""></option>
											<?php foreach ($seldep as $dep) { ?>
												<option value="<?=$dep[id_dept]?>"><?=$dep['nama_dept']?></option>
											<?php } ?>
										</select>
									</div>
								</div>
								<div class="col-sm-8" id="coldep" style="display: none">
									<div class="input-group input-group-icon" id="coldep">
										<select class="form-control" placeholder="None Selected" name="dep" id="dep1">
							...
							<!-- <div class="form-group mb-lg">
								...
								<div class="col-sm-3" style="vertical-align: middle;">
									<strong style="font-size: 14px;">Assets ID</strong>
								</div>
								<div class="col-sm-8">
									<div class="input-group input-group-icon">
										<input name="asetid" id="asetid" type="text" class="form-control" onkeypress="return allvalscript(event)" required/>
									</div>
								</div>
							</div> -->
							...
							<div class="form-group mb-lg">
								...
								<div class="col-sm-8">
									<div class="input-group input-group-icon">
										<input type="text" class="form-control" id="email" name="email" placeholder="use your eratex email" required>
 ...
 -->
		...
		function inputfu(){
			...
			$.ajax({
				...
				url:  "simpan.php?fu=1",
				data: data,
				success: function(idreq) {
					alert("Saved Success");
					$('#convert').load("feedback.php?reload=1&idr="+idreq);
					$('#followup').val('');
